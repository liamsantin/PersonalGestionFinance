...
public class AuthRepository
{
    ...
    public async Task<User?> GetByEmailAsync(string email)
    {
        ...
        cmd.CommandText = "SELECT user_email, user_password FROM TA_USER WHERE user_email = @email";
    ...
    public async Task AddAsync(AuthRequest authRequest)
    {
        ...
        cmd.CommandText = "INSERT INTO TA_USER (user_nom, user_prenom, user_email, user_password, user_phone, addr_id) " +
            "VALUES (@nom, @prenom, @email, @password, @phone, @addrId)";
